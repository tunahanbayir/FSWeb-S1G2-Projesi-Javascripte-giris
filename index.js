...
function kopeginYasi(x) {return x*7}
...
function oyun(oyuncu, bilgisayar) {if (oyuncu === bilgisayar) {return "Beraberlik";}
else if (
...
function milDonusturucu(km) {return km * 0.621371;}
...
function feetDonusturucu(cm) {return cm / 30.48;
...
function notHesapla(sinavSonucu) {if (sinavSonucu >= 90 ) {return "A aldın";}
else if (sinavSonucu >= 80 ) {return "B aldın";}
else if (sinavSonucu >= 70 ) {return "C aldın";} 
else if (sinavSonucu >= 60 ) {return "D aldın";}
else if (sinavSonucu < 60 ) {return "F aldın"}
}
